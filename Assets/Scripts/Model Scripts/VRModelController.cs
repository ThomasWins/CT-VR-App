...
public class VRModelController : MonoBehaviour
{
    ...
    public float scaleSpeed = 0.0005f; // New variable for scaling speed

    private UnityEngine.XR.Interaction.Toolkit.Interactables.XRSimpleInteractable interactable;
    public ModelManager modelManager; // Reference to ModelManager (public since we have 2 in the scene)
    ...
    private void Update()
    {
        ...
        if (inputVector.magnitude > 0.1f)
        {
            ...
            currentModel.transform.Rotate(Vector3.up, yRotation, Space.World);
